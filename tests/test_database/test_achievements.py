...
async def test_update_achievement_progress():
    ...
    await upsert_achievements("2", [{"achievement_id": "a1", "name": "Test", "progress_state": "NotStarted"}])

    await update_achievement_progress(
        "2",
        [
            {
                "achievement_id": "a1",
                "progress_state": "Achieved",
                "gamerscore": 20,
                "time_unlocked": "2023-01-02T00:00:00Z",
            }
        ],
    )
